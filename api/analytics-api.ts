...
export const analyticsApi = {
  getCategoryAnalyticsDetails: async (
    ...
    const response = await httpClient.get('/api/analytics/categories/details', {
      params,
    })
  ...
  getCourseAnalyticsDetails: async (
    ...
    const response = await httpClient.get('/api/analytics/courses/details', {
      params,
    })
    return response.data
  },
  ...
  getStudentAnalyticsDetails: async (
    ...
    const response = await httpClient.get('/api/analytics/students/details', {
      params,
    })
    return response.data
  },
  ...
  getRevenueAnalyticsDetails: async (
    ...
    const response = await httpClient.get('/api/analytics/revenue/details', {
      params,
    })
    return response.data
  },
