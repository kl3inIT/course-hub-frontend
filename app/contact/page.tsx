...
export default function ContactPage() {
  ...
  const supportCategories = [
    ...
    },
    {
      ...
      description: "Questions about enrollment, certificates, or learning paths",
    },
    {
              ...
              <Card key={index} className="text-center hover:shadow-lg transition-shadow cursor-pointer">
                <CardHeader>
                  <div className="flex justify-center mb-4">
                    <div className="p-4 rounded-full bg-primary/10 text-primary">{category.icon}</div>
                  </div>
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto">
          <div className="text-center space-y-4 mb-8">
            ...
            <p className="text-muted-foreground">Visit our office in the heart of San Francisco</p>
          </div>
          <div className="bg-muted/50 rounded-lg h-96 flex items-center justify-center">
            <div className="text-center space-y-2">
              <MapPin className="h-12 w-12 text-muted-foreground mx-auto" />
              <p className="text-muted-foreground">Interactive map would be displayed here</p>
              <p className="text-sm text-muted-foreground">123 Learning Street, San Francisco, CA 94105</p>
            </div>
          </div>
        </div>
      </section>
