...
export default function AddCategoryPage() {
  const [newCategory, setNewCategory] = useState<CategoryRequestDTO>({ name: '', description: '' })
  ...
  const handleCreateCategory = async () => {
    ...
    try {
      ...
      toast.error('Error', { description: 'Failed to create category. Please try again.' })
    } finally {
      setLoading(false)
    }
  }
                ...
                <div className='max-w-xl mx-auto px-4'>
                  <form className='space-y-4'>
                    ...
                    <div className='flex justify-end gap-2 mt-6'>
                      ...
                      <Button type='button' onClick={handleCreateCategory} disabled={!newCategory.name.trim() || !newCategory.description.trim() || loading}>
