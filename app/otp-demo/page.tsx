...
type DemoType = "email-verification" | "password-reset" | "two-factor" | "phone-verification" | null
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <Card className="mb-8">
            <CardHeader>
              ...
              <CardDescription>Our OTP verification system includes all these features</CardDescription>
            </CardHeader>
            <CardContent>
              ...
              <div className="space-y-3 text-sm">
                <div className="p-3 bg-green-50 border border-green-200 rounded-lg">
                  ...
                  <p className="text-green-700">
                    Enter <code className="bg-green-100 px-1 rounded">123456</code> for successful verification
                  </p>
                </div>
                <div className="p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                  <p className="font-medium text-yellow-800">⏰ Expired Code</p>
                  <p className="text-yellow-700">
                    Enter <code className="bg-yellow-100 px-1 rounded">000000</code> to simulate expired code
                  </p>
                </div>
                <div className="p-3 bg-red-50 border border-red-200 rounded-lg">
                  <p className="font-medium text-red-800">❌ Invalid Code</p>
                  <p className="text-red-700">Enter any other 6-digit code to see error handling</p>
                </div>
              </div>
            </CardContent>
          </Card>
