      ...
      <div className="container mx-auto px-4 py-16 max-w-2xl">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Select how you'd like to receive your two-factor authentication codes</CardDescription>
          </CardHeader>
          <CardContent>
            <Tabs value={method} onValueChange={(value) => setMethod(value as "sms" | "email")}>
              ...
              <TabsContent value="sms" className="space-y-4">
                <Alert>
                  <Smartphone className="h-4 w-4" />
                  <AlertDescription>
                    We'll send a 6-digit code to your phone number whenever you sign in.
                  </AlertDescription>
                </Alert>
                ...
                <Button onClick={handleSetup} disabled={!phoneNumber || isLoading} className="w-full">
              ...
              <TabsContent value="email" className="space-y-4">
                <Alert>
                  <Mail className="h-4 w-4" />
                  <AlertDescription>
                    We'll send a 6-digit code to your email address whenever you sign in.
                  </AlertDescription>
                </Alert>
                ...
                <Button onClick={handleSetup} disabled={!email || isLoading} className="w-full">
                  {isLoading ? "Setting up..." : "Send Verification Code"}
                </Button>
              </TabsContent>
            </Tabs>
            ...
            <div className="mt-8 space-y-4">
              <div className="border-t pt-6">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Save these backup codes in a safe place. You can use them to access your account if you lose access to
                  your 2FA method.
                </p>
