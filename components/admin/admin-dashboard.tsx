...
export function AdminDashboard() {
  ...
  const recentActivities = [
    ...
    { id: 2, action: "Course published", user: "jane.manager@example.com", time: "15 minutes ago" },
    { id: 3, action: "Payment processed", user: "student@example.com", time: "30 minutes ago" },
    { id: 4, action: "User role updated", user: "admin@example.com", time: "1 hour ago" },
  ]

  const recentTransactions = [
    { id: 1, transactionId: "TXN123", amount: 50, status: "success", time: "1 minute ago" },
    { id: 2, transactionId: "TXN124", amount: 100, status: "pending", time: "5 minutes ago" },
    { id: 3, transactionId: "TXN125", amount: 25, status: "failed", time: "10 minutes ago" },
    { id: 4, transactionId: "TXN126", amount: 75, status: "success", time: "15 minutes ago" },
    { id: 5, transactionId: "TXN127", amount: 120, status: "success", time: "20 minutes ago" },
    { id: 6, transactionId: "TXN128", amount: 60, status: "pending", time: "25 minutes ago" },
    { id: 7, transactionId: "TXN129", amount: 90, status: "success", time: "30 minutes ago" },
    { id: 8, transactionId: "TXN130", amount: 40, status: "failed", time: "35 minutes ago" },
    { id: 9, transactionId: "TXN131", amount: 80, status: "success", time: "40 minutes ago" },
    { id: 10, transactionId: "TXN132", amount: 110, status: "success", time: "45 minutes ago" },
  ]
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-2">System overview and administrative controls.</p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Last 10 transactions with quick actions</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            {recentTransactions.map((transaction) => (
              <div key={transaction.id} className="flex items-center justify-between p-3 border rounded-lg">
                <div>
                  <p className="text-sm font-medium">Transaction ID: {transaction.transactionId}</p>
                  <p className="text-xs text-muted-foreground">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Active users, new registrations, and engagement metrics</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Server response time, database performance, and API health</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <div className="text-center p-4 border rounded-lg">
              <div className="text-2xl font-bold text-blue-600">{serverResponseTime}s</div>
              <p className="text-sm text-muted-foreground">Server Response Time</p>
            </div>
            <div className="text-center p-4 border rounded-lg">
              <div className="text-2xl font-bold text-green-600">{databasePerformance}%</div>
              <p className="text-sm text-muted-foreground">Database Performance</p>
            </div>
            <div className="text-center p-4 border rounded-lg">
              <div className="text-2xl font-bold text-green-600">{apiEndpointHealth}%</div>
              <p className="text-sm text-muted-foreground">API Endpoint Health</p>
            </div>
            <div className="text-center p-4 border rounded-lg">
