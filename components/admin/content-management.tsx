...
export function ContentManagement() {
  ...
  const handleStatusChange = (contentId: string, newStatus: string) => {
    setContent(
      content.map(c => (c.id === contentId ? { ...c, status: newStatus } : c))
    )
    toast({
    ...
    <div className='space-y-6'>
      <div>
        ...
        <p className='text-muted-foreground mt-2'>
          Manage all content, media assets, and publishing workflows.
        </p>
      </div>
        ...
        <TabsContent value='workflow' className='space-y-4'>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Configure content approval and publishing processes
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className='space-y-6'>
