...
const systemPerformance = [
  { metric: "API Response Time", value: 245, unit: "ms", status: "good", trend: -5 },
  { metric: "Database Queries", value: 1247, unit: "/min", status: "good", trend: 12 },
  { metric: "Error Rate", value: 0.02, unit: "%", status: "excellent", trend: -15 },
  { metric: "Memory Usage", value: 68, unit: "%", status: "warning", trend: 8 },
]

const alertsData = [
  { id: 1, type: "warning", message: "High memory usage detected", time: "5 minutes ago", severity: "medium" },
  { id: 2, type: "info", message: "Scheduled maintenance in 2 hours", time: "1 hour ago", severity: "low" },
  { id: 3, type: "success", message: "Database backup completed", time: "2 hours ago", severity: "low" },
  { id: 4, type: "error", message: "Payment gateway timeout", time: "3 hours ago", severity: "high" },
]
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-2">Real-time insights and system performance monitoring</p>
        </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card className="cursor-pointer hover:shadow-md transition-shadow">
          ...
          <CardContent>
            <div className="text-2xl font-bold">{realtimeMetrics.totalUsers.toLocaleString()}</div>
            <div className="flex items-center text-xs text-green-600">
              <TrendingUp className="h-3 w-3 mr-1" />+{realtimeMetrics.monthlyGrowth}% from last month
            </div>
        ...
        <Card className="cursor-pointer hover:shadow-md transition-shadow">
          ...
          <CardContent>
            <div className="text-2xl font-bold">${realtimeMetrics.totalRevenue.toLocaleString()}</div>
            <div className="flex items-center text-xs text-green-600">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Payment processing success metrics</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="text-center">
                    <div className="text-4xl font-bold text-green-600">{realtimeMetrics.transactionSuccess}%</div>
            ...
            {systemPerformance.map((metric) => (
              <Card key={metric.metric}>
                ...
                <CardContent>
                  ...
                  <div className={`flex items-center text-xs mt-1 ${getPerformanceColor(metric.status)}`}>
                    {metric.trend > 0 ? (
                      <TrendingUp className="h-3 w-3 mr-1" />
                    ) : (
                  ...
                  <Badge variant="outline" className={`mt-2 ${getPerformanceColor(metric.status)}`}>
                    {metric.status}
                  </Badge>
                </CardContent>
              </Card>
        ...
        <TabsContent value="activity" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Active users and login activity throughout the day</CardDescription>
            </CardHeader>
            <CardContent>
              <ResponsiveContainer width="100%" height={300}>
