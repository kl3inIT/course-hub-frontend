...
export function SecurityMonitoring() {
  ...
  const getSecurityStats = () => {
    ...
    const blockedAttempts = loginAttempts.filter(
      l => l.status === 'failed'
    ).length
    ...
    <div className='space-y-6'>
      <div>
        ...
        <p className='text-muted-foreground mt-2'>
          Monitor security threats, audit logs, and system access patterns.
        </p>
      </div>
        ...
        <TabsContent value='access' className='space-y-4'>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Monitor login attempts and user access patterns
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
          ...
          <div className='grid gap-4 md:grid-cols-2'>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Automated security monitoring status
                </CardDescription>
              </CardHeader>
              <CardContent className='space-y-4'>
                <div className='flex items-center justify-between'>
