    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className='max-w-4xl max-h-[90vh] overflow-y-auto'>
        <DialogHeader>
          ...
          <DialogDescription>
            Complete transaction information and related activities
          </DialogDescription>
        </DialogHeader>
                  ...
                  <div className='flex justify-between'>
                    ...
                    <div className='flex items-center gap-2'>
                      ...
                      <Button
                        ...
                        size='sm'
                        onClick={() =>
                          copyToClipboard(transaction.userEmail, 'Email')
                        }
                      >
                  ...
                  <div className='flex justify-between'>
                    ...
                    <div className='flex items-center gap-2'>
                      ...
                      <Button
                        ...
                        size='sm'
                        onClick={() =>
                          copyToClipboard(transaction.userId, 'User ID')
                        }
                      >
                        <Copy className='h-3 w-3' />
                      </Button>
              ...
              <Card>
                ...
                <CardContent className='space-y-3'>
                  <div className='flex justify-between'>
                    ...
                    <span
                      className={`font-bold text-lg ${transaction.amount < 0 ? 'text-red-600' : 'text-green-600'}`}
                    >
                  ...
                  <div className='flex justify-between'>
                    ...
                    <span className='font-medium'>
                      ${Math.abs(transaction.transactionFee || 0).toFixed(2)}
                    </span>
                  </div>
                  <div className='flex justify-between'>
                    <span className='text-muted-foreground'>Net Amount:</span>
                    <span className='font-medium'>
                      ${Math.abs(transaction.netAmount || 0).toFixed(2)}
                    </span>
                  </div>
                  <Separator />
          ...
          <TabsContent value='timeline' className='space-y-4'>
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Chronological history of transaction events
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <div className='grid gap-4 md:grid-cols-2'>
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Actions you can perform on this transaction
                  </CardDescription>
                </CardHeader>
                <CardContent className='space-y-3'>
