              ...
              <Table>
                ...
                <TableBody>
                  {filteredTransactions.map(transaction => {
                    const statusConfig =
                      transactionStatuses[
                        transaction.status as keyof typeof transactionStatuses
                      ]
                    const paymentConfig =
                      paymentMethods[
                        transaction.paymentMethod as keyof typeof paymentMethods
                      ]
            ...
            <CardContent>
              <div className='text-center py-8'>
                ...
                <p className='text-muted-foreground'>
                  All transactions are currently dispute-free.
                </p>
              </div>
            </CardContent>
          </Card>
        ...
        <TabsContent value='reconciliation' className='space-y-4'>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Reconcile payments with payment gateway reports
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value='reports' className='space-y-4'>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Create custom reports for transaction analysis
              </CardDescription>
            </CardHeader>
            <CardContent>
            ...
            <div className='grid gap-4 py-4'>
              <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                ...
                <div>
                  ...
                  <Input
                    value={selectedTransaction.courseName || 'N/A'}
                    readOnly
                  />
                </div>
              </div>
