...
export function CourseCard({
  ...
  const hasDiscount =
    course.discount && course.discount > 0 && course.price > course.finalPrice
      ...
      >
        ...
        <div className='aspect-video relative overflow-hidden'>
          ...
          <div className='absolute top-2 left-2 flex gap-2'>
            {isFree && <Badge className='bg-green-500 text-white'>FREE</Badge>}
            {hasDiscount && (
        ...
        <CardContent
          className={`space-y-3 ${variant === 'compact' ? 'p-4 pt-0' : 'p-5 pt-0'}`}
        >
          {/* Description */}
