    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-600">
          ...
          <span className="capitalize">{feedback.category?.toLowerCase().replace('_', ' ') || 'N/A'}</span>
        </div>
        <div className="flex items-center gap-2 text-sm text-gray-600">
      ...
      <div>
        ...
        <p className="text-gray-700 bg-gray-50 p-3 rounded-lg">{feedback.subject}</p>
      </div>
      ...
      <div>
        ...
        <div className={`rounded-lg p-4 ${
          ...
          {feedback.adminReply ? (
            <p className="text-gray-800 whitespace-pre-wrap">{feedback.adminReply}</p>
          ) : (
