...
export function ReviewManagement() {
    ...
    const fetchCourses = async () => {
      ...
      try {
        ...
        const coursesResponse =
          await courseApi.getCoursesByCategory(categoryFilter)
  ...
  const renderFilters = () => (
    <div
      className='flex flex-col space-y-4 md:flex-row md:space-y-0 md:space-x-4 min-h-[56px]'
          ...
          <div className='flex items-center space-x-3'>
            ...
            <div className='flex-1'>
              ...
              <div className='flex items-center gap-2 mt-1'>
                <span
                  className='px-2 py-1 bg-blue-100 text-blue-800 text-xs font-medium rounded-full truncate max-w-[120px]'
                ...
                <span
                  className='text-xs text-gray-600 font-medium truncate max-w-[200px]'
