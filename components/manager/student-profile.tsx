        ...
        {error === "Student not found" && (
          <Card>
            <CardContent className="flex flex-col items-center justify-center py-12">
              ...
              <Button onClick={() => router.push("/manager/students")}>Return to Student List</Button>
            </CardContent>
          </Card>
        )}
      </div>
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-3xl font-bold">Student Profile</h1>
            <p className="text-muted-foreground">Detailed view of student information and progress</p>
          </div>
        </div>
        ...
        <div className="md:col-span-2 grid gap-4 md:grid-cols-2">
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">{student.completedCourses} completed</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">Course ratings given</p>
            </CardContent>
          </Card>
        ...
        <TabsContent value="courses" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Complete overview of student's course enrollment and progress</CardDescription>
            </CardHeader>
            <CardContent>
            ...
            <>
              <div className="grid gap-4 md:grid-cols-4">
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">{performance.totalStudyTime}h</div>
                    <p className="text-xs text-muted-foreground">Avg {performance.averageSessionTime}min/session</p>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground">Quiz & assignment scores</p>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">{performance.streakDays}</div>
                    <p className="text-xs text-muted-foreground">Days consecutive</p>
                  </CardContent>
                </Card>
              </div>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Student's learning progress over the past months</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    {performance.monthlyProgress.map((month, index) => (
                      <div key={index} className="flex items-center justify-between p-3 border rounded">
                        ...
                        <div className="flex items-center space-x-6 text-sm">
                          <span>{month.coursesCompleted} courses completed</span>
        ...
        <TabsContent value="details" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Detailed personal and account information</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div>
                  ...
                  <p className="text-sm">{new Date(student.joinDate).toLocaleDateString()}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-muted-foreground">Last Active</label>
                  <p className="text-sm">{new Date(student.lastActive).toLocaleDateString()}</p>
                </div>
              </div>
