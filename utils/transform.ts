...
export const transformCoupon = (
  ...
  return {
    ...
    availableQuantity:
      'availableQuantity' in couponData ? couponData.availableQuantity || 0 : 0,
    totalCategory:
      'totalCategory' in couponData ? couponData.totalCategory || 0 : 0,
    totalCourse: 'totalCourse' in couponData ? couponData.totalCourse || 0 : 0,
    categoryIds:
      'categoryIds' in couponData ? couponData.categoryIds || [] : [],
